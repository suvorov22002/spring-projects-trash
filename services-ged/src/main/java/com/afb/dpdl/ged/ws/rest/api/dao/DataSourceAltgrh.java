...
/**
 * Gère le pull de connexion vers la BD de ALTGRH
 * @author narcisse_ekoumlong
 *
 */
public class DataSourceAltgrh implements IDataSource{
	private static DataSourceAltgrh ds;
	private BasicDataSource basicDS = new BasicDataSource();

	 //private constructor
	 private DataSourceAltgrh(String driver, String cnxString, String user, String pwd){
	 ...
	 */
	 public static DataSourceAltgrh getInstance(String driver, String cnxString, String user, String pwd){
	    if(ds == null){
	        ds = new DataSourceAltgrh(driver, cnxString, user, pwd); 
	    }
	    return ds;
	 }
