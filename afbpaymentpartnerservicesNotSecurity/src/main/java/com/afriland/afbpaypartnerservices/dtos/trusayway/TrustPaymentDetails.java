...
@JsonAutoDetect
public class TrustPaymentDetails implements Serializable {
 ...
 // The payment description
	 ...
	 * @param description
	 */
	public TrustPaymentDetails(Long createtime, String intent, String acquirertrxref, String tomember, Long amount,
	...
	public String toString() {
		return "TrustPaymentDetails [createtime=" + createtime + ", intent=" + intent + ", acquirertrxref="
				+ acquirertrxref + ", tomember=" + tomember + ", amount=" + amount + ", currency=" + currency
				+ ", payerinfo=" + payerinfo + ", billList=" + billList + ", description=" + description + "]";
	}
